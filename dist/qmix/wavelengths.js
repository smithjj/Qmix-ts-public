...
export function computeCanonicalWavelengths(input) {
    const wavelengths = [
    ...
    if (zeroIndexes.length === 0) {
        ...
        if (energyError > 1e-12) {
            throw new Error(`Wavelengths do not satisfy energy conservation: 1/${red1} + 1/${red2} = 1/${expectedBlue.toFixed(4)}, not 1/${blue}`);
        }
...
//# sourceMappingURL=wavelengths.js.map